  ...
  const html = wrap(`
    <div style="background:#111;border:1px solid #1f1f1f;border-radius:12px;padding:36px;margin-bottom:20px;">
      ...
      <p style="color:#9ca3af;font-size:14px;line-height:1.6;margin:0 0 24px;">
        Bonjour <strong style="color:#fff;">${prenom || 'Revendeur'}</strong>, votre paiement a bien été reçu. Voici le récapitulatif de votre commande.
      </p>
      ...
      <div style="background:#0d0d0d;border-radius:8px;padding:14px 16px;margin-bottom:24px;display:inline-block;width:100%;box-sizing:border-box;">
        ...
        <p style="color:#C4962A;font-size:20px;font-weight:900;letter-spacing:0.1em;margin:0;font-family:monospace;">${orderId}</p>
      </div>
...
export async function sendAdminOrderNotification({ orderId, clientName, email, total, items }) {
  ...
  const html = wrap(`
    <div style="background:#111;border:1px solid #1f1f1f;border-radius:12px;padding:36px;margin-bottom:20px;">
      ...
      <h1 style="color:#C4962A;font-size:32px;font-weight:900;letter-spacing:0.08em;margin:0 0 24px;font-family:monospace;">${orderId}</h1>
      ...
      <table style="width:100%;border-collapse:collapse;margin-bottom:28px;">
        <tr>
          ...
          <td style="padding:10px 0;border-bottom:1px solid #1a1a1a;color:#e5e7eb;font-size:13px;font-weight:700;">${clientName || '—'}</td>
        </tr>
        <tr>
          ...
          <td style="padding:10px 0;border-bottom:1px solid #1a1a1a;"><a href="mailto:${email}" style="color:#C4962A;text-decoration:none;font-size:13px;">${email || '—'}</a></td>
        </tr>
        <tr>
