...
export default function Home() {
  ...
  return (
    <main className="bg-transparent overflow-x-hidden">
      ...
      {/* ── TRUST BAR ── */}
      <section className="border-y border-white/10 py-6 md:py-8" style={{ background: 'rgba(10,6,0,0.6)', backdropFilter: 'blur(8px)' }}>
          ...
          <div className="grid grid-cols-3 lg:grid-cols-6 gap-2 md:gap-3">
            {categories.map((cat) => (
              <Link
                key={cat.name}
                href="/produits"
                className="group text-center p-4 md:p-6 border hover:border-[#C4962A]/50 transition-all duration-300 rounded"
                style={{ background: 'rgba(15,10,0,0.7)', borderColor: 'rgba(255,255,255,0.07)', backdropFilter: 'blur(4px)' }}
              >
        ...
        <div className="max-w-7xl mx-auto px-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/10">
            {[
              ...
              <div key={item.step} className="p-6 md:p-10 text-center" style={{ background: 'rgba(10,6,0,0.8)' }}>
      ...
      <section className="py-12 md:py-20 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-5">
          <div className="grid md:grid-cols-2 gap-px bg-white/10 rounded overflow-hidden">
            <div className="p-6 md:p-12" style={{ background: 'rgba(10,6,0,0.85)' }}>
            ...
            <div className="p-6 md:p-12 flex items-center justify-center min-h-[300px]" style={{ background: 'rgba(15,10,0,0.7)' }}>
              <div className="text-center">
                ...
                <div className="mt-8 grid grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={b.text} className="border border-white/10 rounded p-3 text-center" style={{ background: 'rgba(0,0,0,0.5)' }}>
        ...
        <div className="max-w-7xl mx-auto px-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
            {testimonials.map((t, i) => (
              <div key={i} className="p-6 md:p-8 rounded" style={{ background: 'rgba(15,10,0,0.7)', border: '1px solid rgba(255,255,255,0.07)', backdropFilter: 'blur(4px)' }}>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-5 text-center">
          <div className="border border-white/10 rounded p-10 md:p-16" style={{ background: 'rgba(10,6,0,0.6)', backdropFilter: 'blur(8px)' }}>
