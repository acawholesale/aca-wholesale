...
export default function Panier() {
  ...
  const inputClass = "w-full bg-[#111] border border-white/10 px-4 py-3 text-sm text-white focus:outline-none focus:border-[#C4962A] placeholder-gray-700"
          ...
          {['Panier', 'Livraison', 'Confirmation'].map((s, i) => {
            ...
            return (
              <div key={s} className="flex items-center gap-2">
                <div className={`w-7 h-7 flex items-center justify-center text-xs font-black ${isPast ? 'bg-green-600 text-white' : !isActive ? 'bg-white/5 text-gray-600' : 'text-black'}`} style={isActive ? { background: 'linear-gradient(135deg, #C4962A, #E8B84B)' } : {}}>
                  {isPast ? '✓' : i + 1}
                </div>
        ...
        {step === 'cart' && (
          <div className="grid md:grid-cols-3 gap-5 md:gap-8">
            <div className="md:col-span-2 space-y-3">
              {items.map(item => (
                <div key={item.id} className="bg-[#111] border border-white/10 p-4 flex gap-3 items-center">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-1 bg-black border border-white/10 px-1">
            ...
            <div className="hidden md:block md:col-span-1">
              <div className="bg-[#111] border border-white/10 p-5 sticky top-20">
        ...
        {step === 'form' && (
          <div className="grid md:grid-cols-3 gap-5 md:gap-8">
            <div className="md:col-span-2">
              <form onSubmit={handleSubmit} className="bg-[#111] border border-white/10 p-6 md:p-8">
                ...
                <div className="mb-6"><label className={labelClass}>Notes / Préférences de tailles</label><textarea name="notes" value={form.notes} onChange={handleChange} rows={3} className={inputClass} placeholder="Indiquez vos préférences..."></textarea></div>
