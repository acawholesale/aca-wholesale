        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 text-sm text-white placeholder-gray-600 rounded outline-none focus:ring-1"
              style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', focusRingColor: '#C4962A' }}
            />
          </div>
          <div>
