  ...
  return (
    <main>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={v.title} className="bg-gray-50 p-10 border text-center">
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-black text-white p-12 flex items-center justify-center aspect-square">
              <div className="text-center">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={item.title} className="p-6 border bg-gray-50 text-center">
