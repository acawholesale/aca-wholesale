          ...
          <div className="flex items-center justify-between h-14 md:h-16">
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <div className="hidden sm:flex flex-col items-center gap-0.5">
                <Link
                  href="/connexion"
                  className="flex items-center gap-1.5 border border-white/20 text-gray-200 text-xs px-3 py-1.5 font-bold uppercase tracking-wide hover:border-white/50 hover:text-white transition-colors rounded"
                >
        ...
        {menuOpen && (
          <div className="md:hidden bg-[#0a0a0a] border-t border-white/10">
            <div className="px-5 py-4 space-y-1">
              ...
              <Link
                href="/admin"
                className="block text-xs py-2 px-3 text-gray-600 hover:text-gray-400"
                onClick={() => setMenuOpen(false)}
              >
                🔐 Accès admin
              </Link>
