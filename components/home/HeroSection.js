    ...
    <section className="relative text-white overflow-hidden min-h-[80vh] md:min-h-screen flex items-center">
      ...
      <div className="relative max-w-7xl mx-auto px-5 py-20 md:py-32 w-full">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 border border-white/20 text-gray-300 text-[10px] font-bold px-3 py-1.5 mb-6 uppercase tracking-widest rounded-sm">
          ...
          <p className="text-gray-300 text-sm md:text-lg mb-8 leading-relaxed max-w-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link
              href="/produits"
              className="btn-gold text-black px-8 py-4 font-black text-sm uppercase tracking-widest text-center rounded cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-black focus:ring-white"
            >
              VOIR NOS LOTS →
            </Link>
            <Link
          ...
          <div ref={statsRef} className="flex gap-6 md:gap-10 mt-12 pt-12 border-t border-white/10">
            <div className="text-center">
              ...
              <div className="text-gray-400 text-[10px] md:text-xs mt-1 uppercase tracking-wide">Revendeurs</div>
            </div>
            <div className="text-center">
              <div className="text-xl md:text-3xl font-black text-gold-light">{c2}</div>
              <div className="text-gray-400 text-[10px] md:text-xs mt-1 uppercase tracking-wide">Lots dispos</div>
            </div>
            <div className="text-center">
              <div className="text-xl md:text-3xl font-black text-gold-light">{c3}h</div>
              <div className="text-gray-400 text-[10px] md:text-xs mt-1 uppercase tracking-wide">Réponse max</div>
            </div>
            <div className="text-center">
              <div className="text-xl md:text-3xl font-black text-gold-light">{c4}%</div>
              <div className="text-gray-400 text-[10px] md:text-xs mt-1 uppercase tracking-wide">Authentique</div>
            </div>
          </div>
        </div>
      </div>
